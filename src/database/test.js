...
Database.then(async (db)=>{
    ...
    const classValue = {
        subject: 1,
        cost: "20,00", 
        //o porffy_id virá pelo banco de dados
    }
    ...
    //.* significa tudo daquela tabela, e é usando qnd tem que unir 2 tabela em uma única const
    //join significa juntar, abaixo estarei juntando as tabela
    ...
    //o horário que a pessoa trabalha é das (8) as (18)
